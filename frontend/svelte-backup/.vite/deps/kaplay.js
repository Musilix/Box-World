...
var Tn = (_a9 = class {
  ...
  transform(e) {
    return new _a9(e.multVec2(this.pt));
  }
  bbox() {
...
var Te = (_a10 = class {
  ...
  transform(e) {
    return new _a10(e.multVec2(this.p1), e.multVec2(this.p2));
  }
  bbox() {
  ...
  clone() {
    return new _a10(this.p1, this.p2);
  }
  collides(e) {
    return ja(this, e);
  }
...
var W = (_a11 = class {
  ...
  static fromPoints(e, n) {
    return new _a11(e.clone(), n.x - e.x, n.y - e.y);
  }
  center() {
  ...
  clone() {
    return new _a11(this.pos.clone(), this.width, this.height);
  }
  distToPoint(e) {
...
var Ce = (_a12 = class {
  ...
  clone() {
    return new _a12(this.center, this.radius);
  }
  collides(e) {
    return ka(this, e);
  }
...
var je = (_a13 = class {
  ...
  static fromMat2(e) {
    ...
    return u > p ? new _a13(x(), u, p, ct(Math.atan2(-a[1], a[0]))) : new _a13(x(), p, u, ct(Math.atan2(-m[1], m[0])));
  }
  toMat2() {
  ...
  transform(e) {
    if (this.angle == 0 && e.getRotation() == 0) return new _a13(e.multVec2(this.center), e.m[0] * this.radiusX, e.m[5] * this.radiusY);
    {
      let n = this.toMat2(), r = e.getRotation(), o = e.getScale();
      n = ht.fromMat2(n).scale(o.x, o.y).rotate(r).toMat2();
      let a = _a13.fromMat2(n);
  ...
  clone() {
    return new _a13(this.center, this.radiusX, this.radiusY, this.angle);
  }
  collides(e) {
    return Ua(this, e);
  }
...
var ye = (_a14 = class {
  ...
  transform(e) {
    return new _a14(this.pts.map((n) => e.multVec2(n)));
  }
  bbox() {
  ...
  clone() {
    return new _a14(this.pts.map((e) => e.clone()));
  }
  collides(e) {
    return Na(this, e);
  }
  ...
  cut(e, n) {
    ...
    return this.pts.forEach((c) => {
      ...
      (f ? o : s).push(c), m = c;
    }), [o.length ? new _a14(o) : null, s.length ? new _a14(s) : null];
  }
}, i(_a14, "Polygon"), _a14);
function Ao(t, e, n, r) {
...
i(No, "isConvex");
var Uo = i((t) => t[0] instanceof I, "arrayIsColor");
var Ho = i((t) => t[0] instanceof C, "arrayIsVec2");
var qo = i((t) => typeof t[0] == "number", "arrayIsNumber");
var _a15;
var Kt = (_a15 = class {
...
var ke = (_a17 = class {
  ...
  static join(e) {
    let n = new _a17(() => e.forEach((r) => r.cancel()));
...
var De = i((t, e) => Array.isArray(t) ? t == null ? void 0 : t.includes(e) : t === e, "isEqOrIncludes");
var Ye = i((t, e) => Array.isArray(e) ? e.some((n) => t.has(n)) : t.has(e), "setHasOrIncludes");
var en = i((t, e, n) => {
  var _a41;
...
var ri = i((t) => {
  ...
  function Ee(g) {
    var _a41;
    return (_a41 = e.buttons) == null ? void 0 : _a41[g];
  }
  i(Ee, "getButton");
  function k(g, T) {
  ...
  function oo(g) {
    let T = { index: g.index, isPressed: i((S) => {
      var _a41;
      return ((_a41 = e.gamepadStates.get(g.index)) == null ? void 0 : _a41.buttonState.pressed.has(S)) || false;
    }, "isPressed"), isDown: i((S) => {
      var _a41;
      return ((_a41 = e.gamepadStates.get(g.index)) == null ? void 0 : _a41.buttonState.down.has(S)) || false;
    }, "isDown"), isReleased: i((S) => {
      var _a41;
      return ((_a41 = e.gamepadStates.get(g.index)) == null ? void 0 : _a41.buttonState.released.has(S)) || false;
    }, "isReleased"), getStick: i((S) => {
      var _a41;
      return ((_a41 = e.gamepadStates.get(g.index)) == null ? void 0 : _a41.stickState.get(S)) || x();
    }, "getStick") };
      ...
      if (ne) {
        for (let Ae = 0; Ae < T.buttons.length; Ae++) {
          ...
          if (Ze.pressed) {
            ...
            e.lastInputDevice = "gamepad", Rt && ((_a41 = e.buttonsByGamepad.get(oe)) == null ? void 0 : _a41.forEach((Re) => {
          ...
          } else ne.buttonState.down.has(oe) && (Rt && ((_b = e.buttonsByGamepad.get(oe)) == null ? void 0 : _b.forEach((Re) => {
  ...
  Ge.mousedown = (g) => {
    e.events.onOnce("input", () => {
      var _a41;
      let T = so[g.button];
      T && (e.lastInputDevice = "mouse", e.buttonsByMouse.has(T) && ((_a41 = e.buttonsByMouse.get(T)) == null ? void 0 : _a41.forEach((S) => {
    ...
    e.events.onOnce("input", () => {
      var _a41;
      let T = so[g.button];
      T && (e.buttonsByMouse.has(T) && ((_a41 = e.buttonsByMouse.get(T)) == null ? void 0 : _a41.forEach((S) => {
  ...
  Ge.keydown = (g) => {
    Ga.has(g.key) && g.preventDefault(), e.events.onOnce("input", () => {
      ...
      T.length === 1 ? (e.events.trigger("charInput", T), e.charInputted.push(T)) : T === "space" && (e.events.trigger("charInput", " "), e.charInputted.push(" ")), g.repeat ? (e.keyState.pressRepeat(T), e.events.trigger("keyPressRepeat", T)) : (e.lastInputDevice = "keyboard", e.buttonsByKey.has(T) && ((_a41 = e.buttonsByKey.get(T)) == null ? void 0 : _a41.forEach((B) => {
        e.buttonState.press(B), e.events.trigger("buttonPress", B);
      })), e.buttonsByKeyCode.has(S) && ((_b = e.buttonsByKeyCode.get(S)) == null ? void 0 : _b.forEach((B) => {
        e.buttonState.press(B), e.events.trigger("buttonPress", B);
    ...
    g.preventDefault(), e.events.onOnce("input", () => {
      ...
      t.touchToMouse !== false && (e.mousePos = new C(T[0].clientX - S.x, T[0].clientY - S.y), e.lastInputDevice = "mouse", e.buttonsByMouse.has("left") && ((_a41 = e.buttonsByMouse.get("left")) == null ? void 0 : _a41.forEach((B) => {
        e.buttonState.press(B), e.events.trigger("buttonPress", B);
    ...
    e.events.onOnce("input", () => {
      var _a41;
      let T = [...g.changedTouches], S = e.canvas.getBoundingClientRect();
      t.touchToMouse !== false && (e.mousePos = new C(T[0].clientX - S.x, T[0].clientY - S.y), e.mouseDeltaPos = new C(0, 0), e.buttonsByMouse.has("left") && ((_a41 = e.buttonsByMouse.get("left")) == null ? void 0 : _a41.forEach((B) => {
        e.buttonState.release(B), e.events.trigger("buttonRelease", B);
...
function mi() {
  var _a41, _b;
  return ((_b = (_a41 = l.gfx.bgColor) == null ? void 0 : _a41.clone) == null ? void 0 : _b.call(_a41)) ?? null;
}
i(mi, "getBackground");
function Q(...t) {
...
var Eu = on.reduce((t, e) => t + e.size, 0);
var hi = 2048;
var gi = hi * 4 * Eu;
var bi = hi * 6;
var yi = `
...
var ce = (_a27 = class {
  ...
  static loaded(e) {
    let n = new _a27(Promise.resolve(e));
...
var Fe = (_a29 = class {
  ...
  static from(e, n = {}) {
    return typeof e == "string" ? _a29.fromURL(e, n) : Promise.resolve(_a29.fromImage(e, n));
  }
  static fromImage(e, n = {}) {
    ...
    return new _a29(r, s, n.anims, n.slice9);
  }
  static fromURL(e, n = {}) {
    return Ct(e).then((r) => _a29.fromImage(r, n));
  }
}, i(_a29, "SpriteData"), _a29);
function It(t) {
  if (typeof t == "string") {
    let e = Ir(t);
    if (e) return e;
...
var rt = (_a32 = class {
  ...
  static fromArrayBuffer(e) {
    return new Promise((n, r) => l.audio.ctx.decodeAudioData(e, n, r)).then((n) => new _a32(n));
  }
  static fromURL(e) {
    return Dn(e) ? _a32.fromArrayBuffer(zo(e)) : Ai(e).then((n) => _a32.fromArrayBuffer(n));
  }
}, i(_a32, "SoundData"), _a32);
function Ni(t) {
  if (typeof t == "string") {
    let e = Hr(t);
    if (e) return e;
...
function Un(t) {
  ...
  let e = t.start ?? 0, n = t.end ?? 360, r = _e(t.anchor ?? "center").scale(new C(-t.radiusX, -t.radiusY)), o = yt(r, t.radiusX, t.radiusY, e, n, t.resolution);
  o.unshift(r);
...
var Ve = (_a33 = class {
  ...
  static fromImage(e, n, r = {}) {
    let o = new _a33(e, n.width, n.height, r);
...
function Ue(t) {
  ...
  if (e instanceof Et || typeof e == "string") {
    ...
    for (let D of o) if (!P.font.map[D]) {
      ...
      P.outline && P.outline.width && P.outline.color && (b.lineJoin = "round", b.lineWidth = P.outline.width * 2, b.strokeStyle = P.outline.color.toHex(), b.strokeText(D, P.outline.width, P.outline.width), A += P.outline.width * 2, G += P.outline.width * 3), b.fillText(D, ((_a41 = P.outline) == null ? void 0 : _a41.width) ?? 0, ((_b = P.outline) == null ? void 0 : _b.width) ?? 0);
  ...
  for (let V = 0; V < d.length; V++) {
    ...
    for (let P of d[V].chars) {
      ...
      if (n[b]) {
        let E = n[b];
        for (let A of E) {
          let G = (_c = t.styles) == null ? void 0 : _c[A], M = typeof G == "function" ? G(b, P.ch) : G;
          M && $i(P, M);
        }
      }
      w.push(P);
...
function it(t) {
  ...
  let e = t.width, n = t.height, o = _e(t.anchor || pt).scale(new C(e, n).scale(-0.5)), s = t.quad || new z(0, 0, 1, 1), a = t.color || _(255, 255, 255), m = t.opacity ?? 1, u = t.tex ? 0.1 / t.tex.width : 0, p = t.tex ? 0.1 / t.tex.height : 0, c = s.x + u, f = s.y + p, d = s.w - u * 2, v = s.h - p * 2;
...
i(it, "drawUVQuad");
function He(t) {
  be(), Q(t.opt.pos), We(t.opt.angle), Q(_e(t.opt.anchor ?? "topleft").add(1, 1).scale(t.width, t.height).scale(-0.5)), t.chars.forEach((e) => {
...
function ve(t) {
  ...
  if (t.width <= 0 || t.height <= 0) return;
  let e = t.width, n = t.height, o = _e(t.anchor || pt).add(1, 1).scale(new C(e, n).scale(-0.5)), s = [new C(0, 0), new C(e, 0), new C(e, n), new C(0, n)];
  if (t.radius) {
...
function At(t) {
  ...
  if (t.tiled) {
    let a = _e(t.anchor || pt).add(new C(1, 1)).scale(0.5).scale(t.width || n, t.height || r), m = (t.width || n) / n, u = (t.height || r) / r, p = Math.floor(m), c = Math.floor(u), f = m - p, d = u - c, v = (p + f ? 1 : 0) * (c + d ? 1 : 0), h = new Array(v * 6), O = new Array(v * 4), y = 0, w = i((V, R, P, D, b) => {
...
function ys(t, e) {
  ...
  let n = l.game.root.add([St(e.pos ?? x(0))]), r = t.length, o = 0, s = null, a = null, m = null, u = null, p = i((b) => b.x + b.y * o, "tile2Hash"), c = i((b) => x(Math.floor(b % o), Math.floor(b / o)), "hash2Tile"), f = i(() => {
    ...
    for (H.set(G, 0); F.length !== 0; ) {
      let j = (_a41 = F.remove()) == null ? void 0 : _a41.node;
      if (j === M) break;
...
var Qr = me((t) => l.game.events.on("add", t), (t, e) => Qe("add", t, e));
var Cs = me((t) => l.game.events.on("destroy", t), (t, e) => Qe("destroy", t, e));
function Os(t, e, n) {
...
function dn(t = []) {
  let e = /* @__PURE__ */ new Map(), n = [], r = {}, o = new ze(), s = [], a = null, m = false, u = { id: Jo(), hidden: false, transform: new he(), children: [], parent: null, set paused(c) {
    ...
    for (let v in c) {
      ...
      if (h) if (typeof h.value == "function" && (c[v] = c[v].bind(this)), h.set && Object.defineProperty(c, v, { set: h.set.bind(this) }), h.get && Object.defineProperty(c, v, { get: h.get.bind(this) }), wi.has(v)) {
        let O = v === "add" ? () => {
          var _a41;
          a = i((y) => f.push(y), "onCurCompCleanup"), (_a41 = c[v]) == null ? void 0 : _a41.call(c), a = null;
        } : c[v];
    ...
    var _a41;
    let c = {};
    for (let [f, d] of e) c[f] = ((_a41 = d.inspect) == null ? void 0 : _a41.call(d)) ?? null;
  ...
  for (let c of p) u[c] = (...f) => {
    var _a41, _b;
    let d = (_b = (_a41 = l.app)[c]) == null ? void 0 : _b.call(_a41, ...f);
    return s.push(d), u.onDestroy(() => d.cancel()), u.on("sceneEnter", () => {
      var _a42, _b2;
      s.splice(s.indexOf(d), 1);
      let v = (_b2 = (_a42 = l.app)[c]) == null ? void 0 : _b2.call(_a42, ...f);
...
function ks(t, e = {}) {
  ...
  o.loop = !!e.loop, o.detune.value = e.detune ?? 0, o.playbackRate.value = e.speed ?? 1, o.connect(m), o.onended = () => {
    var _a41;
    h() >= (((_a41 = o.buffer) == null ? void 0 : _a41.duration) ?? Number.POSITIVE_INFINITY) && s.trigger();
  ...
  return { stop() {
    ...
    var _a41;
    ((_a41 = o.buffer) == null ? void 0 : _a41.duration) && (y > o.buffer.duration || (r ? (o = O(o), p = c - y) : (o.stop(), o = O(o), p = n.currentTime - y, o.start(0, y), f = true, c = 0)));
  }, set speed(y) {
...
function $s(t, e = {}) {
  function n(o) {
    ...
    return e.width || (o.width = s.width / (((_a41 = o.scale) == null ? void 0 : _a41.x) || 1)), o.height = s.height / (((_b = o.scale) == null ? void 0 : _b.y) || 1), s;
  }
  i(n, "update");
...
}, i(_a37, "AnimateChannel"), _a37);
function ta(t, e) {
  return e.add(e.sub(t));
}
i(ta, "reflect");
var _a38;
var Zr = (_a38 = class extends bn {
  constructor(e, n, r, o) {
    super(e, r, o);
...
}, i(_a38, "AnimateChannelNumber"), _a38);
var _a39;
var eo = (_a39 = class extends bn {
  constructor(e, n, r, o, s) {
    ...
    if (this.keys = n, this.interpolation === "spline") {
      ...
      for (let a = 0; a < this.keys.length - 1; a++) {
        ...
        this.curves.push(Lt(c, m, p, f)), s && ((_a41 = this.dcurves) == null ? void 0 : _a41.push(Lt(c, m, p, f, Lo)));
      }
    }
  }
  update(e, n) {
...
}, i(_a39, "AnimateChannelVec2"), _a39);
var _a40;
var to = (_a40 = class extends bn {
  constructor(e, n, r, o) {
    super(e, r, o);
    __publicField(this, "keys");
    this.keys = n;
...
}, i(_a40, "AnimateChannelColor"), _a40);
function na(t = {}) {
  let e = [], n = 0, r = false;
...
function ya(t) {
  var _a41;
  let e = (_a41 = l.game.layers) == null ? void 0 : _a41.indexOf(t);
  return { id: "layer", get layerIndex() {
    return e ?? null;
  }, get layer() {
    var _a42;
    return e ? ((_a42 = l.game.layers) == null ? void 0 : _a42[e]) ?? null : null;
  }, set layer(n) {
    var _a42;
    if (e = (_a42 = l.game.layers) == null ? void 0 : _a42.indexOf(n), e == -1) throw Error("Invalid layer name");
  }, inspect() {
